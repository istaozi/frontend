...
!function (global) {
    ...
    function newContext(e) {
        function t(e) {
            var t, i, r = e.length;
            for (t = 0; t < r; t++)if (i = e[t], "." === i)e.splice(t, 1), t -= 1; else if (".." === i) {
        ...
        function i(e, i, r) {
            ...
            if (e && "." === e.charAt(0) && (i ? (g = m.slice(0, m.length - 1), e = e.split("/"), p = e.length - 1, y.nodeIdCompat && jsSuffixRegExp.test(e[p]) && (e[p] = e[p].replace(jsSuffixRegExp, "")), e = g.concat(e), t(e), e = e.join("/")) : 0 === e.indexOf("./") && (e = e.substring(2))), r && v && (m || x)) {
                o = e.split("/");
                e:for (s = o.length; s > 0; s -= 1) {
                    if (u = o.slice(0, s).join("/"), m)for (c = m.length; c > 0; c -= 1)if (a = getOwn(v, m.slice(0, c).join("/")), a && (a = getOwn(a, u))) {
                        d = a, f = s;
                        break e
                    }
        ...
        function n(e) {
            ...
            if (t && isArray(t) && t.length > 1)return t.shift(), q.require.undef(e), q.require([e]), !0
        }
        ...
        function o(e, t, r, n) {
            ...
            return e || (l = !1, e = "_@r" + (A += 1)), u = a(e), p = u[0], e = u[1], p && (p = i(p, d, n), s = getOwn(j, p)), e && (p ? h = s && s.normalize ? s.normalize(e, function (e) {
                return i(e, d, n)
            }) : i(e, d, n) : (h = i(e, d, n), u = a(h), p = u[0], h = u[1], r = !0, o = q.nameToUrl(h))), c = !p || s || r ? "" : "_unnormalized" + (T += 1), {prefix: p, name: h, parentMap: t, unnormalized: !!c, url: o, originalName: f, isDefine: l, id: (p ? p + "!" + h : h) + c}
        }
        ...
        function l() {
            ...
            if (!x) {
                if (x = !0, eachProp(k, function (e) {
                        var i = e.map, u = i.id;
                        if (e.enabled && (i.isDefine || s.push(e), !e.error))if (!e.inited && a)n(u) ? (t = !0, c = !0) : (o.push(u), r(u)); else if (!e.inited && e.fetched && i.isDefine && (c = !0, !i.prefix))return p = !1
        ...
        var x, b, q, E, w, y = {waitSeconds: 7, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {}}, S = {}, k = {}, O = {}, M = [], j = {}, P = {}, R = {}, A = 1, T = 1;
        return E = {
            require: function (e) {
            ...
            init: function (e, t, i, r) {
                ...
                this.depMaps.push(r), c(r, "defined", bind(this, function (r) {
                    var n, a, p, f = getOwn(R, this.map.id), l = this.map.name, h = this.map.parentMap ? this.map.parentMap.name : null, m = q.makeRequire(e.parentMap, {enableBuildCallback: !0});
                    return this.map.unnormalized ? (r.normalize && (l = r.normalize(l, function (e) {
                        ...
                        var a = e.name, c = o(a), p = useInteractive;
            ...
            config: y, contextName: e, registry: S, defined: j, urlFetched: P, defQueue: M, Module: b, makeModuleMap: o, nextTick: req.nextTick, onError: u, configure: function (e) {
                ...
                return n = n || {}, mixin(a, {
                    isBrowser: isBrowser, toUrl: function (e) {
                        ...
                        return n !== -1 && (!o || n > 1) && (r = e.substring(n, e.length), e = e.substring(0, n)), q.nameToUrl(i(e, t && t.id, !0), r, !0)
                    }, defined: function (e) {
                ...
                return y.urlArgs ? s + ((s.indexOf("?") === -1 ? "?" : "&") + y.urlArgs) : s
            }, load: function (e, t) {
                req.load(q, e, t)
                ...
                var t = g(e);
                if (!n(t.id))return u(makeError("scripterror", "Script error for: " + t.id, e, [t.id]))
            }
